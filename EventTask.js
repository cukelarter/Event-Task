...
function standardizingRTsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of standardizingRTsComponents)
...
function stdRT_trialsLoopBegin(stdRT_trialsLoopScheduler) {
  ...
  for (const thisStdRT_trial of stdRT_trials) {
...
function stdRT_loopRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of stdRT_loopComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function header_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of header_practiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function header_experimentRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of header_experimentComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function breakblockRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of breakblockComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
